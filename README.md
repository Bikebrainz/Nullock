...
Teaching labs     54 intentionally-vulnerable apps, each mapped to a Nullock probe (labs/);
                  ...
                  Repeater; all 54 labs add a real /flag success-check endpoint
...
- [ ] v4:
  - [x] Web Security Academy clone — **54/50 labs** under [`labs/`](labs/) (past the original goal, still growing)
