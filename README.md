...
Teaching labs     81 intentionally-vulnerable apps, each mapped to a Nullock probe (labs/);
                  ...
                  Repeater; all 81 labs add a real /flag success-check endpoint
...
- [ ] v4:
  - [x] Web Security Academy clone — **81/50 labs** under [`labs/`](labs/) (past the original goal, still growing)
