...
Teaching labs     87 intentionally-vulnerable apps, each mapped to a Nullock probe (labs/);
                  ...
                  Repeater; all 87 labs add a real /flag success-check endpoint
...
- [ ] v4:
  - [x] Web Security Academy clone — **87/50 labs** under [`labs/`](labs/) (past the original goal, still growing)
