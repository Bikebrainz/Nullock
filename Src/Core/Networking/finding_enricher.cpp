...
const QHash<QString, Mapping> &table() {
    static const QHash<QString, Mapping> m = {
        ...
        { "jwt-alg-absent", { "CWE-347", "A02:2021-Cryptographic Failures", 4.3, "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N", "", "The header declares no 'alg' (non-spec) -- confirm the server requires a pinned algorithm and never falls back to none/unsigned." } },
        { "jwt-asym-alg", { "CWE-347", "A02:2021-Cryptographic Failures", 3.1, "CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:L/A:N", "", "Asymmetric token (lead): if the server can be coerced to HMAC-verify (alg->HS256) it may be forgeable with the public key. Confirm with the active alg-confusion probe before treating as exploitable." } },
        { "jwt-exp-malformed", { "CWE-613", "A07:2021-Identification and Authentication Failures", 4.3, "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N", "", "The 'exp' claim is present but not a numeric NumericDate -- a lax verifier may not enforce it. Emit exp as a JSON number." } },
        { "jwt-payload-unparseable", { "CWE-345", "A02:2021-Cryptographic Failures", 0.0, "", "", "The JWT payload is not valid base64url JSON -- the claims could not be analyzed (informational; not a finding about the token's security)." } },
        ...
        { "ws-origin-not-validated", { "CWE-1385", "A05:2021-Security Misconfiguration", 0.0, "", "", "The WebSocket handshake accepts any Origin, but no session credential was supplied so exploitability is unconfirmed -- if the socket is cookie/auth-gated this is CSWSH; validate the Origin regardless. Re-test with a victim session cookie to confirm." } },
