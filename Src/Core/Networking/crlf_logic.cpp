...
// Everything here is I/O-free: the request builder, query assembly, and the
// split-confirmation matcher operate on primitives (a raw response QByteArray,
// a parsed header list, the plain Request struct), never on a response object.
